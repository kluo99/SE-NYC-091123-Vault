...
def create_users():
    ...
    user_1 = User(email="fnuser@test.io", username="friendly_neighborhood_user", password=encrypt_password("hunter2"))
    user_2 = User(email="ituser@test.io", username="into_the_userverse", password=encrypt_password("drowssap"))
    user_3 = User(email="admin@test.io", username="amazing_administrator", password=encrypt_password("abcde12345"), is_admin=True)
